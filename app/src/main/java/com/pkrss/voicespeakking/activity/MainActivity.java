...
import com.pkrss.voicespeakking.fragment.MainEditTextFragment;
import com.pkrss.voicespeakking.fragment.MainTextViewFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainModel.setViewPager(mViewPager);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if(position == 0) {
                MainTextViewFragment ret = new MainTextViewFragment();
                ret.setMainHandler(mainHandler);
                ret.setMainModel(mainModel);
                return ret;
            }

            if(position == 1){
                MainEditTextFragment ret = new MainEditTextFragment();
                ret.setMainHandler(mainHandler);
                ret.setMainModel(mainModel);
                return ret;
            }
